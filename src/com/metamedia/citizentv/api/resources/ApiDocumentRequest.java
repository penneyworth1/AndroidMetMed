...
public class ApiDocumentRequest extends ApiResourceRequest
{		
	// ---------------------------------------------------------------------------------------------------------
	// Constructor
	// ---------------------------------------------------------------------------------------------------------

	public ApiDocumentRequest(CTVResource resource) 
	{
		super(resource);
	}
	...
	public String getUrlPath() 
	{
		...
		String urlPath = "http://" + storageServer.documentHost + "/" + this.getUserFriendlyText() + "-" + this.getResource().resourceKey + ".pdf";
